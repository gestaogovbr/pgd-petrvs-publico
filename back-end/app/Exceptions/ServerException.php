...
class ServerException extends Exception implements IBaseException
{
    private $exceptions = [
        ...
        "ProgramaDestroyWithPT" => "Não é possível excluir Regramento com Plano de Trabalho cadastrado",
        "ProgramaDestroyWithPE" => "Não é possível excluir Regramento com Plano de Entrega cadastrado",

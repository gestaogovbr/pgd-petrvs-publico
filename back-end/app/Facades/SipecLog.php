...
class SipecLog
{
    ...
    private static function ensureFilePermissions(): void
    {
        ...
        $filename = storage_path('logs/sipec_' . $tenantId . '.log');
    ...
    public static function info($message, array $context = [])
    {
        ...
        Log::channel('sipec')->info($message, $context);
    ...
    {
        self::ensureFilePermissions();
        Log::channel('sipec')->error($message, $context);
        if (self::$imprimirNoTerminal) {
            imprimeNoTerminal($message);
        }
    }
    ...
    {
        self::ensureFilePermissions();
        Log::channel('sipec')->warning($message, $context);
        if (self::$imprimirNoTerminal) {
            imprimeNoTerminal($message);
        }
    }

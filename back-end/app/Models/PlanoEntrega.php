...
class PlanoEntrega extends ModelBase
{
    ...
    public function latestStatus() { return $this->hasOne(StatusJustificativa::class, "plano_entrega_id")->latestOfMany();}
    ...
    public function avaliacoes() { return $this->hasMany(Avaliacao::class, 'plano_entrega_id'); } 
    // Belongs

...
class ProjetoTarefa extends ModelBase
{
  ...
  {
    return $this->hasMany(ProjetoAlocacao::class, "tarefa_id");
  }
  public function tarefas()
  {
    return $this->hasMany(ProjetoTarefa::class, "tarefa_pai_id");
  }
  ...
  public function tarefaPai()
  {
    return $this->belongsTo(ProjetoTarefa::class);
  }       //nullable
}

...
class PlanoService extends ServiceBase
{
    ...
    public function validateStore($data, $unidade, $action) {
        ...
        $planos = Plano::where("usuario_id", $data["usuario_id"])->where("unidade_id", $data["unidade_id"])->where("tipo_modalidade_id", $data["tipo_modalidade_id"])->whereNull("data_fim")->get();

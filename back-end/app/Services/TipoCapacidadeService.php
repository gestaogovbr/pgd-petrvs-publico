...
class TipoCapacidadeService extends ServiceBase {
    public $tiposCapacidades = [
        ...
        ["1aadc1b3-f199-11ec-a5bb-0050569c64a0", "MOD_PTR_INTSC_DATA", "Permite incluir planos de trabalho para usuários que já possuem planos no período de mesma modalidade"],

...
class TipoCapacidadeService extends ServiceBase {
    ...
    public $tiposCapacidades = [
        ...
        ["MOD_ATV", "Permite acessar item menu demandas"],
        ["MOD_ATV_TIPO_ATV", "Permite associar atividade com demanda"],
        ["MOD_ATV_TIPO_ATV_CMPLX", "Permite associar complexidade da atividade na demanda"],
        ["MOD_ATV_TIPO_ATV_DT_DST", "Permite associar data de distribuição com atividade em demanda"],
        ["MOD_ATV_TIPO_ATV_PL_TRB", "Permite associar plano de trabalho com ativ/demanda"],
        ["MOD_ATV_TIPO_ATV_PZ_ENTG", "Permite associar prazo entrega de atividade da demanda"],
        ["MOD_ATV_TIPO_ATV_RESP", "Permite associar responsável pela demanda"],
        ...
        ["MOD_ATV_CONCL", "Permite concluir demandas iniciadas "],
        ...
        ["MOD_ATV_CONS", "Permite consultar demanda"],
        ["MOD_ATV_EDT", "Permite editar demanda"],
        ["MOD_ATV_EXCL", "Permite excluir demanda"],
        ["MOD_ATV_EXT", "Permite atribuir demandas a Unidades externas"],
        ["MOD_ATV_I_AVAL", "Permite avaliar demanda iniciada"],
        ["MOD_ATV_I_CANC", "Permite cancelar demanda iniciada"],
        ["MOD_ATV_I_COMT", "Permite comentar demanda iniciada"],
        ["MOD_ATV_I_CONCL", "Permite concluir demandas iniciadas "],
        ["MOD_ATV_I_EDT_INIC", "Permite editar início de demanda iniciada"],
        ["MOD_ATV_I_INFO", "Permite obter informação sobre demandas iniciadas"],
        ["MOD_ATV_I_PPRZO", "Permite prorrogar prazo de demanda iniciada"],
        ["MOD_ATV_I_SUSP", "Permite suspender demanda iniciada"],
        ["MOD_ATV_INCL", "Permite incluir demanda"],
        ["MOD_ATV_INCL_COMPL", "Permite incluir complemtários para demandas"],
        ["MOD_ATV_INCL_COMT", "Permite incluir comentários nas demandas"],
        ["MOD_ATV_INCL_CRTZ", "Permite incluir caracterização para atividade de demanda"],
        ["MOD_ATV_INCL_VNCL", "Permite incluir vínculos na demanda"],
        ["MOD_ATV_INICIAR", "Permite iniciar a demanda"],
        ["MOD_ATV_INICIO", "Permite definir início demanda"],
        ["MOD_ATV_MDL_INICIAR", "Permite iniciar modalidade"],
        ["MOD_ATV_NI_COMT", "Permite comentar demanda não iniciada"],
        ["MOD_ATV_NI_EXCL", "Permite excluir demanda não iniciada"],
        ["MOD_ATV_NI_INFO", "Permite obter informação sobre demandas não iniciadas"],
        ["MOD_ATV_NI_INIC", "Permite iniciar demanda não iniciada"],
        ["MOD_ATV_NI_CONCL", "Permite concluir demanda não iniciada"],
        ["MOD_ATV_RESP_INICIAR", "Permite incluir responsável por demanda"],
        ["MOD_ATV_SUSP_DMAIS", "Permite suspender demais demandas"],
        ["MOD_ATV_ATV_VAZIO", "Permite deixar campo Atividade em branco na inclusão da Demanda"],
        ["MOD_ATV_USERS_CANC_CONCL", "Permitir cancelar conclusão de demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_CANC_INICIAR", "Permite cancelar início de demanda de de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_ALT", "Permite alterar a demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_CONCL", "Permite concluir a demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_INICIAR", "Permite iniciar a demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_PAUSA", "Permitir pausar/suspender demanda iniciada de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_ALT_CONCL", "Permite alterar conclusão de demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_COMT", "Permite adicionar comentário de demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_PPRZO", "Permite prorrogar prazo de demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_AVAL", "Permite avaliar demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_ALT_AVAL", "Permite alterar avaliação de demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_EXCL", "Permite excluir demanda de qualquer usuário, inclusive de outra lotação"],
        ["MOD_ATV_USERS_ATRIB", "Permite qualquer usuário atribuir demanda para qualqer outro"],
        ["MOD_ATV_TRF_INCL", "Permite incluir tarefas dentro de demandas"],
        ["MOD_ATV_TRF_EDT", "Permite editar tarefas dentro de demandas"],
        ["MOD_ATV_TRF_EXCL", "Permite exluir tarefas dentro de demandas"],
        ["MOD_ATV_TRF_CONS", "Permite consultar tarefas dentro de demandas"],
        ["MOD_ATV_CLONAR", "Permite clonar demandas"],

...
class CreateProjetosAlocacoesRegrasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('projetos_alocacoes_regras', function (Blueprint $table) {
            ...
            // Campos:
            // Chaves estrangeiras:
            $table->foreignUuid('projeto_alocacao_id')->constrained("projetos_alocacoes")->onDelete('restrict')->onUpdate('cascade');

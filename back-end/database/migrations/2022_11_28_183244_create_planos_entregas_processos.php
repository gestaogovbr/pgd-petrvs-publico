...
class CreatePlanosEntregasProcessos extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('planos_entregas_processos', function (Blueprint $table) {
            // Configurações:
            $table->uuid('id');
            $table->primary('id');
            $table->timestamps();
            ...
            // Chaves estrangeiras:
            $table->foreignUuid('processo_id')->constrained("cadeias_valores_processos")->onDelete('restrict')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('planos_entregas_processos');
    }
}

...
class CreatePlanosEntregasEntregasObjetivosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('planos_entregas_entregas_objetivos', function (Blueprint $table) {
            ...
            $table->foreignUuid('plano_entrega_entrega_id')->constrained("planos_entregas_entregas")->onDelete('restrict')->onUpdate('cascade')->comment("")->comment("Entrega do Plano de Entregas à qual está vinculado este objetivo");
        });
    }

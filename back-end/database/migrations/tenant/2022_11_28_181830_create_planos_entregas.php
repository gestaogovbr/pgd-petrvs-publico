...
class CreatePlanosEntregas extends Migration
{
    ...
    public function up()
    {
        Schema::create('planos_entregas', function (Blueprint $table) {
            ...
            $table->foreignUuid('criacao_usuario_id')->nullable()->constrained("usuarios")->onDelete('restrict')->onUpdate('cascade')->comment("Usuário responsável pela criação do plano de entregas");
        });

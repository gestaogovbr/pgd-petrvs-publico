...
class CreateUnidadesIntegrantesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('unidades_integrantes', function (Blueprint $table) {
            ...
            $table->softDeletes();
            // Campos:
            $table->enum("atribuicao", ["AVALIADOR_ATIVIDADE","AVALIADOR_PLANO_ENTREGA","AVALIADOR_PLANO_TRABALHO","HOMOLOGADOR_PLANO_ENTREGA"])->comment("Vínculo que o servidor tem com a unidade");
            // Chaves estrangeiras:

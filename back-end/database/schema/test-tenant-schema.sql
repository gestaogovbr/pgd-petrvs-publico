...
CREATE TABLE `planejamentos_objetivos` (
  ...
  `tipo_objetivo_id` char(36) DEFAULT NULL COMMENT 'Tipo do objetivo (opcional)',
  ...
  KEY `fk_planej_obj_tipo_objetivo_id` (`tipo_objetivo_id`),
  ...
  CONSTRAINT `fk_planej_obj_tipo_objetivo_id` FOREIGN KEY (`tipo_objetivo_id`) REFERENCES `planejamentos_tipos_objetivos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `planos_trabalhos_entregas` (
  ...
  `esforco_executado` decimal(5,2) NOT NULL DEFAULT 0.00 COMMENT 'Percentual de CHD executado na entrega (registro de execução)',
  `meta` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Meta para a entrega' CHECK (json_valid(`meta`)),

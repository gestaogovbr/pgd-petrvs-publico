"use strict";
(self["webpackChunkpetrvs"] = self["webpackChunkpetrvs"] || []).push([[205],{
...
class PerfilFormComponent extends src_app_modules_base_page_form_base__WEBPACK_IMPORTED_MODULE_8__.PageFormBase {
  ...
  static #_ = this.ɵfac = function PerfilFormComponent_Factory(t) {
    return new (t || PerfilFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_15__.Injector));
  };
...
const routes = [{
  ...
  loadChildren: () => __webpack_require__.e(/*! import() */ 448).then(__webpack_require__.bind(__webpack_require__, /*! ./capacidade/capacidade.module */ 18448)).then(m => m.CapacidadeModule),
  canActivate: [src_app_guards_auth_guard__WEBPACK_IMPORTED_MODULE_0__.AuthGuard]
}, {
  path: ':id/consult',
  component: _perfil_form_perfil_form_component__WEBPACK_IMPORTED_MODULE_2__.PerfilFormComponent,

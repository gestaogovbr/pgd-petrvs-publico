...
class PlanejamentoFormObjetivoComponent extends src_app_modules_base_page_form_base__WEBPACK_IMPORTED_MODULE_6__.PageFormBase {
  ...
  loadData(entity, form) {
    ...
    return (0,_usr_src_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      //if(this.planejamento) this.planejamento.planejamento_superior = this.metadata.planejamento.planejamento_superior as Planejamento || null;
...
class PlanejamentoFormComponent extends src_app_modules_base_page_form_base__WEBPACK_IMPORTED_MODULE_6__.PageFormBase {
  constructor(injector) {
      ...
      var _ref = (0,_usr_src_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (form) {
        ...
        */
        yield _this.dao?.query({
          where: [["unidade_id", "==", _this.form.controls.unidade_id.value], ["id", "!=", _this.entity?.id]]
        }).getAll().then(planejamentos => {
          planejamentos.forEach(p => {
            if (_this.utilService.intersection([{
              start: _this.utilService.asDate(p.data_inicio),
              end: _this.utilService.asDate(p.data_fim)
            }, {
              start: _this.utilService.asDate(_this.entity?.data_inicio),
              end: _this.utilService.asDate(_this.entity?.data_fim)
            }])) result = "O período de duração deste planejamento coincide com outro da mesma unidade.";
          });
        });
        return result;
      });
    ...
    this.utilService = injector.get(src_app_services_util_service__WEBPACK_IMPORTED_MODULE_7__.UtilService);
  ...
  carregaPlanejamentosSuperiores() {
    this.dao?.query({
      ...
      this.planejamentosSuperiores = planejamentos.map(x => Object.assign({}, {
        key: x.id,
        value: x.nome
      }));
...
_class.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵdefineComponent"]({
  ...
  template: function PlanejamentoFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵelement"](15, "input-textarea", 11)(16, "input-textarea", 12);
      _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵelementEnd"]();
      _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵelementStart"](17, "div", 10)(18, "div", 3)(19, "input-multiselect", 13);
      _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵelement"](20, "input-text", 14);
      _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵelementEnd"]()()()()()();
      _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵelementStart"](21, "tab", 15);
      _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵelement"](22, "planejamento-list-objetivo", 16, 17);
      _angular_core__WEBPACK_IMPORTED_MODULE_17__["ɵɵelementEnd"]()()();
    }
    if (rf & 2) {

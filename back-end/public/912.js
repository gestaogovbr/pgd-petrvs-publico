...
_class = TipoProcessoFormComponent;
_class.ɵfac = function TipoProcessoFormComponent_Factory(t) {
...
_class = TipoProcessoListComponent;
_class.ɵfac = function TipoProcessoListComponent_Factory(t) {
...
_class.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineComponent"]({
  ...
  decls: 10,
  vars: 21,
  consts: [[3, "dao", "add", "title", "orderBy", "groupBy", "join", "selectable", "hasAdd", "hasEdit", "select"], [4, "ngIf"], [3, "form", "where", "submit", "clear", "collapseChange", "collapsed"], [1, "row"], ["controlName", "nome", "placeholder", "Nome...", 3, "size", "label"], ["title", "C\u00F3digo", "field", "codigo"], ["title", "Descri\u00E7\u00E3o", "field", "nome"], ["type", "options", 3, "onEdit", "options"], [3, "rows"]],
...
_class = TipoProcessoRoutingModule;
_class.ɵfac = function TipoProcessoRoutingModule_Factory(t) {
  return new (t || _class)();
};
...
_class = TipoProcessoModule;
_class.ɵfac = function TipoProcessoModule_Factory(t) {
  return new (t || _class)();
};
_class.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineNgModule"]({
  type: _class

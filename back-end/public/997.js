...
/* harmony import */ var src_app_modules_uteis_documentos_documento_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/modules/uteis/documentos/documento.service */ 22702);
...
function PlanoTrabalhoListComponent_ng_template_41_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelement"](0, "badge", 57);
  }
  if (rf & 2) {
...
function PlanoTrabalhoListComponent_ng_template_46_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"](row_r61.numero);
  }
}
function PlanoTrabalhoListComponent_ng_template_49_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"]((row_r62.usuario == null ? null : row_r62.usuario.matricula) || "");
  }
}
function PlanoTrabalhoListComponent_ng_template_52_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"]((row_r63.programa == null ? null : row_r63.programa.nome) || "");
  }
}
function PlanoTrabalhoListComponent_ng_template_55_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"]((row_r64.unidade == null ? null : row_r64.unidade.nome) || "");
  }
}
function PlanoTrabalhoListComponent_ng_template_58_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"]((row_r65.tipo_modalidade == null ? null : row_r65.tipo_modalidade.nome) || "");
  }
}
function PlanoTrabalhoListComponent_ng_template_61_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"](ctx_r35.util.getDateTimeFormatted(row_r66.data_inicio));
  }
}
function PlanoTrabalhoListComponent_ng_template_64_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"](ctx_r37.util.getDateTimeFormatted(row_r67.data_fim));
  }
}
function PlanoTrabalhoListComponent_ng_template_67_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"]((row_r68.documento == null ? null : row_r68.documento.numero_processo == null ? null : row_r68.documento.numero_processo.length) ? row_r68.documento == null ? null : row_r68.documento.numero_processo : "N\u00E3o atribu\u00EDdo");
  }
}
class PlanoTrabalhoListComponent extends src_app_modules_base_page_list_base__WEBPACK_IMPORTED_MODULE_9__.PageListBase {
  ...
  botaoAtendeCondicoes(botao, planoTrabalho) {
    var _this = this;
    let unidadeExecutora;
    let assinaturasExigidas = [];
    let condicao3 = false;
    let condicao5 = false;
    let condicao9 = false;
    (0,_usr_src_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.unidadeDao.getById(planoTrabalho.unidade_id, ["gestor.usuario:id"]).then(response => {
        unidadeExecutora = response;
        condicao3 = _this.auth.usuario?.id == unidadeExecutora?.gestor?.usuario?.id; // usuário logado é o gestor da unidade executora
      });

      _this.programaDao.assinaturasExigidas(planoTrabalho.programa_id).then(response => {
        assinaturasExigidas = response;
        condicao9 = _this.auth.usuario ? assinaturasExigidas.includes(_this.auth.usuario.id) : false; // assinatura do usuário logado é uma das exigidas
      });

      _this.usuarioDao.jaAssinouTCR(_this.auth.usuario?.id ?? null, planoTrabalho.id).then(response => {
        condicao5 = response; // usuário logado é um dos que já assinaram o TCR
      });
    })();

    let condicao1 = this.planoTrabalhoService.situacaoPlano(planoTrabalho) == 'INCLUIDO'; //plano com status INCLUIDO
    let condicao2 = this.auth.usuario?.id == planoTrabalho.usuario_id; //usuário logado é participante do plano
    let condicao4 = this.planoTrabalhoService.situacaoPlano(planoTrabalho) == 'AGUARDANDO_ASSINATURA'; //plano com status AGUARDANDO_ASSINATURA
    let condicao6 = this.planoTrabalhoService.situacaoPlano(planoTrabalho) == 'ATIVO'; //plano com status ATIVO
    let condicao7 = this.planoTrabalhoService.situacaoPlano(planoTrabalho) == 'CONCLUIDO'; //plano com status CONCLUIDO
    let condicao8 = this.planoTrabalhoService.situacaoPlano(planoTrabalho) == 'ARQUIVADO'; //plano ARQUIVADO
    let condicao10 = !!assinaturasExigidas.filter(a => a != this.auth.usuario?.id).length;
    let condicao11 = this.planoTrabalhoService.situacaoPlano(planoTrabalho) == 'SUSPENSO'; //plano SUSPENSO
    switch (botao) {
      case this.BOTAO_ALTERAR:
        ...
        */
        return this.auth.hasPermissionTo("MOD_PTR_EDT") && this.planoTrabalhoService.isValido(planoTrabalho) && (condicao1 && condicao2 || condicao3 || condicao4 && condicao5 || condicao6 && condicao3 && this.auth.hasPermissionTo("MOD_PTR_EDT_ATV"));
      case this.BOTAO_ARQUIVAR:
        ...
        */
        return condicao7 && !condicao8 && (condicao2 || condicao3);
        ...
        /*
          (RN_PTR_O) ASSINAR
            ...
            - ou o plano precisa estar com o status AGUARDANDO_ASSINATURA, e:
              - a assinatura do usuário logado precisa ser uma das exigidas pelo Programa de Gestão, e ele não ter ainda assinado;
        */
        return condicao1 && (condicao2 || condicao3) && condicao9 && !condicao5 || condicao4 && condicao9 && !condicao5;
      case this.BOTAO_ATIVAR:
        ...
        */
        return condicao1 && (condicao2 || condicao3) && !assinaturasExigidas.length;
      ...
      case this.BOTAO_DESARQUIVAR:
        ...
        */
        return condicao8 && (condicao2 || condicao3);
      case this.BOTAO_ENVIAR_ASSINATURA:
        ...
        */
        return condicao1 && (condicao2 || condicao3) && condicao10;
...
_class.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineComponent"]({
  ...
  template: function PlanoTrabalhoListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtemplate"](41, PlanoTrabalhoListComponent_ng_template_41_Template, 1, 3, "ng-template", null, 28, _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtemplateRefExtractor"]);
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵproperty"]("size", 6)("dao", ctx.tipoModalidadeDao);
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"](1);

...
class PlanoListComponent extends src_app_modules_base_page_list_base__WEBPACK_IMPORTED_MODULE_8__["PageListBase"] {
    constructor(injector) {
        ...
        /*this.options.push({
          label: "Termo adesão",
          icon: "bi bi-info-circle",
          onClick: ((row: Plano) => this.go.navigate({route: ['gestao', 'plano', 'termo']}, {metadata: {plano: row, processo: {id_processo: 1, numero_processo: "1", id_documento: 1, numero_documento: "1"}}, modalClose: (modalResult) => console.log(modalResult?.conteudo)})).bind(this)
        });*/
    }
    filterClear(filter) {
...
//# sourceMappingURL=default~listeners-listeners-module~modules-gestao-plano-plano-module.b821011c2176ed991b3c.js.map
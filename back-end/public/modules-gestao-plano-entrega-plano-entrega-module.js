...
class PlanoEntregaFormEntregaComponent extends src_app_modules_base_page_form_base__WEBPACK_IMPORTED_MODULE_7__["PageFormBase"] {
    constructor(injector) {
        ...
        this.validate = (control, controlName) => {
            ...
            else if (['fim'].indexOf(controlName) && control.value && !((_e = this.dao) === null || _e === void 0 ? void 0 : _e.validDateTime(control.value))) {
                result = "Inválido";
            }
            return result;
        };

...
let TipoAvaliacaoRoutingModule = class TipoAvaliacaoRoutingModule {
};
TipoAvaliacaoRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], TipoAvaliacaoRoutingModule);
export { TipoAvaliacaoRoutingModule };
//# sourceMappingURL=tipo-avaliacao-routing.module.js.map
...
let CapacidadeRoutingModule = class CapacidadeRoutingModule {
};
CapacidadeRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], CapacidadeRoutingModule);
export { CapacidadeRoutingModule };
//# sourceMappingURL=capacidade-routing.module.js.map
...
let AtividadeListGridComponent = class AtividadeListGridComponent extends AtividadeListBase {
    static { this.selectRoute = { route: ["gestao", "atividade", "grid"] }; }
    ...
    onAgruparChange(event) {
        ...
        if (agrupar)
            groupByOptions.push({ field: "unidade.sigla", label: "Unidade" });
        if (agrupar_entrega)
            groupByOptions.push({ field: "plano_trabalho_entrega.plano_entrega_entrega.descricao", label: "Entrega" });
    ...
    async onColumnAtividadeDescricaoSave(row) {
        try {
            ...
            const saved = await this.dao.update(row.id, {
                ...
                comentarios: (this.formEdit.controls.comentarios.value || []).filter((x) => ["ADD", "EDIT", "DELETE"].includes(x._status || ""))
            });
...
], AtividadeListGridComponent.prototype, "grid", void 0);
__decorate([
    ViewChild('calendarEfemerides', { static: false })
], AtividadeListGridComponent.prototype, "calendarEfemerides", void 0);
__decorate([
    ViewChild('unidade', { static: false })
], AtividadeListGridComponent.prototype, "unidade", void 0);
__decorate([
    ViewChild('usuario', { static: false })
], AtividadeListGridComponent.prototype, "usuario", void 0);
__decorate([
    ViewChild('tipoAtividade', { static: false })
], AtividadeListGridComponent.prototype, "tipoAtividade", void 0);
__decorate([
    ViewChild('etiqueta', { static: false })
], AtividadeListGridComponent.prototype, "etiqueta", void 0);
__decorate([
    ViewChild('planoEntrega', { static: false })
], AtividadeListGridComponent.prototype, "planoEntrega", void 0);
__decorate([
    ViewChild('planoEntregaEntrega', { static: false })
], AtividadeListGridComponent.prototype, "planoEntregaEntrega", void 0);
__decorate([
    Input()
], AtividadeListGridComponent.prototype, "snapshot", void 0);
__decorate([
    Input()
], AtividadeListGridComponent.prototype, "fixedFilter", void 0);
__decorate([
    Input()
], AtividadeListGridComponent.prototype, "minhas", void 0);
AtividadeListGridComponent = __decorate([
    Component({
...
export { AtividadeListGridComponent };
//# sourceMappingURL=atividade-list-grid.component.js.map
...
let PlanejamentoRoutingModule = class PlanejamentoRoutingModule {
};
PlanejamentoRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], PlanejamentoRoutingModule);
export { PlanejamentoRoutingModule };
//# sourceMappingURL=planejamento-routing.module.js.map
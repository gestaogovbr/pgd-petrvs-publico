...
const routes = [
    ...
    { path: ':id/clone', component: PlanoEntregaFormComponent, canActivate: [AuthGuard], resolve: { config: ConfigResolver }, runGuardsAndResolvers: 'always', data: { title: "Clone de Plano de Entregas", modal: true, clone: true } },
...
let PlanoEntregaRoutingModule = class PlanoEntregaRoutingModule {
};
PlanoEntregaRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], PlanoEntregaRoutingModule);
export { PlanoEntregaRoutingModule };
//# sourceMappingURL=plano-entrega-routing.module.js.map
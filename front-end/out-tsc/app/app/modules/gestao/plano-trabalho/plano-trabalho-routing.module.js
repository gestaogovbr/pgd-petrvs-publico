...
let PlanoTrabalhoRoutingModule = class PlanoTrabalhoRoutingModule {
};
PlanoTrabalhoRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], PlanoTrabalhoRoutingModule);
export { PlanoTrabalhoRoutingModule };
//# sourceMappingURL=plano-trabalho-routing.module.js.map
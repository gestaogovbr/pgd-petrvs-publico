...
let SolucaoRoutingModule = class SolucaoRoutingModule {
};
SolucaoRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], SolucaoRoutingModule);
export { SolucaoRoutingModule };
//# sourceMappingURL=solucao-routing.module.js.map
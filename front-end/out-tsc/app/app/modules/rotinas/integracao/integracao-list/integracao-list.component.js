...
let IntegracaoListComponent = class IntegracaoListComponent extends PageListBase {
    ...
    dynamicButtons(row) {
        ...
        if (this.auth.hasPermissionTo("MOD_DEV_TUDO"))
...
], IntegracaoListComponent.prototype, "grid", void 0);
__decorate([
    ViewChild('selectResponsaveis', { static: false })
], IntegracaoListComponent.prototype, "selectResponsaveis", void 0);
IntegracaoListComponent = __decorate([
    Component({
...
export { IntegracaoListComponent };
//# sourceMappingURL=integracao-list.component.js.map
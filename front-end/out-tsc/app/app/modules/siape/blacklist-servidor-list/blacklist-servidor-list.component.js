...
let BlacklistServidorListComponent = class BlacklistServidorListComponent extends PageListBase {
    constructor(injector) {
        ...
        this.options.push({
            ...
            onClick: (row) => this.removerCpf(row.cpf)
        });
    }
    async removerCpf(cpf) {
        try {
...
], BlacklistServidorListComponent.prototype, "grid", void 0);
BlacklistServidorListComponent = __decorate([
    Component({
...
export { BlacklistServidorListComponent };
//# sourceMappingURL=blacklist-servidor-list.component.js.map
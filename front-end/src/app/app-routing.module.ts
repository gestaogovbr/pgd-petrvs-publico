...
const routes: Routes = [
  ...
  { path: 'impersonate', component: TesteImpersonateComponent, canActivate: [AuthGuard], resolve: { config: ConfigResolver }, runGuardsAndResolvers: 'always', data: { title: "Personificar", permission: 'MENU_DEV_ACESSO' } },

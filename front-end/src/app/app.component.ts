...
export class AppComponent {
  ...
  public setMenuVars() {
    this.menuSchema = {
      ...
      CURRICULUM_CADASTRO_ATIVIDADES_EXTERNAS: { name: this.lex.translate("Atividades Externas"), permition: 'MOD_RX_VIS_DPE', route: ['raiox', 'cadastros','areaatividadeexterna'], icon: "bi bi-arrows-fullscreen" },
      ...
      CURRICULUM_CADASTRO_QUESTIONARIOS_PERGUNTAS: { name: this.lex.translate("Perguntas"), permition: 'MOD_RX_VIS_DPE', route: ['raiox', 'cadastros','questionario'], icon: "bi bi-patch-question" },
    ...
    this.menuRaioX = [{
      ...
      menu: [
        ...
        "-",
        this.menuSchema.CURRICULUM_CADASTRO_ATIVIDADES_EXTERNAS,

...
export class AppComponent {
  ...
  public setMenuVars() {
    this.menuSchema = {
      ...
      PLANEJAMENTOS_INSTITUCIONAIS: { name: this.lex.translate("Planejamentos Institucionais"), permition: 'MOD_PLAN', route: ['gestao', 'planejamento'], icon: this.entity.getIcon('Planejamento') },

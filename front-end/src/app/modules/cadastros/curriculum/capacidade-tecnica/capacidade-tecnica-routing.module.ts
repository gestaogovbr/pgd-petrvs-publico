...
import { CapacidadeListComponent } from 'src/app/modules/configuracoes/perfil/capacidade/capacidade-list/capacidade-list.component';
import { CapacidadeTecnicaFormComponent } from './capacidade-tecnica-form/capacidade-tecnica-form.component';

const routes: Routes = [
    { path: '', component: CapacidadeListComponent, canActivate: [AuthGuard], resolve: { config: ConfigResolver }, runGuardsAndResolvers: 'always', data: { title: "Lista", modal: false } },

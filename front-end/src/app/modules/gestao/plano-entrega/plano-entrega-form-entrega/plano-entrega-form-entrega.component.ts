...
export class PlanoEntregaFormEntregaComponent extends PageFormBase<PlanoEntregaEntrega, PlanoEntregaEntregaDaoService> {
  ...
  public formValidation = (form?: FormGroup) => {
    ...
    if(!this.dao?.validDateTime(inicio)) {
      ...
      return "Data de inicio menor que a data de inicio" + this.lex.translate("plano de entrega", false, true) + ": " + this.util.getDateFormatted(this.planoEntrega.inicio);
    } else if(this.planoEntrega && this.planoEntrega.fim && fim > this.planoEntrega.fim) {
      return "Data de fim maior que a data de fim" + this.lex.translate("plano de entrega", false, true) + ": " + this.util.getDateFormatted(this.planoEntrega.fim);
    }
    return undefined;
  }

...
export class ProdutoShowComponent extends PageFrameBase {
  ...
  public async carregaProdutoDetalhado(){
    this.produto = await this.produtoDaoService.getById(this.metadata.produto.id, ["produtoProcessoCadeiaValor.cadeiaValorProcesso.cadeiaValor.unidade"]);
  }
}
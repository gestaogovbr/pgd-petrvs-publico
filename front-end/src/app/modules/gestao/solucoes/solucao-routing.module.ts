...
const routes: Routes = [
  ...
  { path: 'filter', component: SolucaoFiltroComponent, canActivate: [AuthGuard], resolve: { config: ConfigResolver }, runGuardsAndResolvers: 'always', data: { title: "Solução - Busca Avançada", modal: true } },

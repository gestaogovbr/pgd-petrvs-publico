...
export class EntityService {
    ...
    public constructor(public injector: Injector) {
        ...
        this.list = [
            ...
            { collection: 'Materia', codigo: 'MOD_RX_CURR', table: 'materias', campo: 'nome', icon: 'bi bi-list-check', dao: injector.get<CursoDaoService>(CursoDaoService), label: "Matérias", selectRoute: { route: ['raiox', 'cadastros','materia'] } },

...
export class EntityService {
    ...
    public constructor(public injector: Injector) {
        ...
        this.list = [
            {collection: 'Adesao',                      codigo: '',                 table: '',                                              campo: '',                      icon: 'bi bi-universal-access-circle',                                                                                                          label: "Adesão"                       },
            ...
            {collection: 'Change',                      codigo: '',                 table: 'changes',                                       campo: 'row_id',                icon: 'bi bi-filter-square',            dao: injector.get<ChangeDaoService>(ChangeDaoService),                                                  label: "Log de Alteração",                  selectRoute: {route: ['logs', 'change']}},
            ...
            {collection: 'Error',                       codigo: '',                 table: 'errors',                                        campo: 'type',                  icon: 'bi bi-bug',                      dao: injector.get<ErrorDaoService>(ErrorDaoService),                                                    label: "Log de Erro",                       selectRoute: {route: ['logs', 'error']}},
            ...
            {collection: 'Integracao',                  codigo: '',                 table: 'integracoes',                                   campo: 'usuario_id',            icon: 'bi bi-pencil-square',            dao: injector.get<IntegracaoDaoService>(IntegracaoDaoService),                                          label: "Integração"                                  },
            ...
            {collection: 'Planejamento',                codigo: 'MOD_PLAN_INST',    table: 'planejamentos',                                 campo: 'nome',                  icon: 'bi bi-rulers',                   dao: injector.get<PlanejamentoDaoService>(PlanejamentoDaoService),                                      label: "Planejamento Institucional",        selectRoute: {route: ['gestao', 'planejamento']}},
            {collection: 'PlanejamentoObjetivo',        codigo: '',                 table: 'planejamentos_objetivos',                       campo: 'nome',                  icon: 'bi bi-bullseye',                 dao: injector.get<PlanejamentoObjetivoDaoService>(PlanejamentoObjetivoDaoService),                      label: "Objetivo do Planejamento"                                  },
            ...
            {collection: 'Preferencia',                 codigo: '',                 table: '',                                              campo: '',                      icon: 'bi bi-person-fill-gear',                                                                                                                 label: "Preferência"                                  },
            ...
            {collection: 'Traffic',                     codigo: '',                 table: 'traffic',                                       campo: 'url',                   icon: 'bi bi-stoplights',               dao: injector.get<TrafficDaoService>(TrafficDaoService),                                                label: "Log de Tráfego",                    selectRoute: {route: ['logs', 'traffic']}},

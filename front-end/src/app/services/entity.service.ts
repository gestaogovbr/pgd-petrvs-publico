...
export class EntityService {
    ...
    public lex: LexicalService;
        ...
        this.list = [
            ...
            { collection: 'CapacidadeTecnica', codigo: 'MOD_RX', table: 'capacidades_tecnicas', campo: 'nome', icon: 'bi bi-arrows-angle-contract', dao: injector.get<CapacidadeTecnicaDaoService>(CapacidadeTecnicaDaoService), label: "Capacidade Técnica", selectRoute: { route: ['raiox', 'cadastros','capacidadetecnica'] } },
            { collection: 'Cargo', codigo: 'MOD_RX', table: 'cargos', campo: 'nome', icon: 'bi bi-person-badge', dao: injector.get<CargoDaoService>(CargoDaoService), label: "Cargo", selectRoute: { route: ['raiox', 'cadastros','cargo'] } },
            ...
            { collection: 'CentroTreinamento', codigo: 'MOD_RX', table: 'centros_treinamentos', campo: 'nome', icon: 'bi bi-building-fill', dao: injector.get<CentroTreinamentoDaoService>(CentroTreinamentoDaoService), label: "Centro de Treinamento", selectRoute: { route: ['raiox', 'cadastros','centrotreinamento'] } },
            ...
            { collection: 'Funcao', codigo: 'MOD_RX', table: 'funcoes', campo: 'nome', icon: 'bi bi-check-circle-fill', dao: injector.get<FuncaoDaoService>(FuncaoDaoService), label: "Função", selectRoute: { route: ['raiox', 'cadastros','funcao'] } },
            { collection: 'GrupoEspecializado', codigo: 'MOD_RX', table: 'grupos_especializados', campo: 'nome', icon: 'bi bi-check-circle', dao: injector.get<GrupoEspecializadoDaoService>(GrupoEspecializadoDaoService), label: "Grupos Especializados", selectRoute: { route: ['raiox', 'cadastros','grupoespecializado'] } },
            ...
            { collection: 'Planejamento', codigo: 'MOD_PLAN', table: 'planejamentos', campo: 'nome', icon: 'bi bi-journals', dao: injector.get<PlanejamentoDaoService>(PlanejamentoDaoService), label: "Planejamento Institucional", selectRoute: { route: ['gestao', 'planejamento'] } },
            ...
            { collection: 'PlanoEntregaEntrega', codigo: 'MOD_PENT_ENTR', table: 'planos_entregas_entregas', campo: 'descricao', icon: 'bi bi-list-check', dao: injector.get<PlanoEntregaEntregaDaoService>(PlanoEntregaEntregaDaoService), label: "Entrega do Plano de Entrega", selectRoute: { route: ['gestao', 'plano-entrega', 'entregaList'] } },
            ...
            { collection: 'TipoCurso', codigo: 'MOD_RX', table: 'tipos_cursos', campo: 'nome', icon: 'bi bi-box2', dao: injector.get<TipoCursoDaoService>(TipoCursoDaoService), label: "Tipo de Curso", selectRoute: { route: ['raiox','cadastros', 'tipocurso'] } },

...
export class EntityService {
    ...
    public constructor(public injector: Injector) {
        ...
        this.list = [
            ...
            {collection: 'Atividade',                   codigo: 'MOD_ATV',          table: 'atividades',                                    campo: 'nome',                  icon: '',                               dao: injector.get<AtividadeDaoService>(AtividadeDaoService),                                            label: "Atividade",                         selectRoute: {route: ['gestao', 'atividade']}},
            ...
            {collection: 'CadeiaValorProcesso',         codigo: '',                 table: 'cadeias_valores_processos',                     campo: 'nome',                  icon: '',                               dao: injector.get<CadeiaValorProcessoDaoService>(CadeiaValorProcessoDaoService),                        label: "Processo da Cadeia de Valor"       },
            {collection: 'Capacidade',                  codigo: '',                 table: 'capacidades',                                   campo: 'tipo_capacidade_id',    icon: '',                               dao: injector.get<CapacidadeDaoService>(CapacidadeDaoService),                                          label: "Capacidade"                                  },
            {collection: 'Change',                      codigo: '',                 table: 'changes',                                       campo: 'row_id',                icon: '',                               dao: injector.get<ChangeDaoService>(ChangeDaoService),                                                  label: "Log de Alteração",                  selectRoute: {route: ['logs', 'change']}},
            ...
            {collection: 'DemandaEntrega',              codigo: '',                 table: 'demandas_entregas',                             campo: 'demanda_id',            icon: '',                               dao: injector.get<DemandaEntregaDaoService>(DemandaEntregaDaoService),                                  label: "Entrega da Demanda"                                  },
            {collection: 'Documento',                   codigo: '',                 table: 'documentos',                                    campo: 'numero',                icon: '',                               dao: injector.get<DocumentoDaoService>(DocumentoDaoService),                                            label: "Documento"                                  },
            {collection: 'EixoTematico',                codigo: 'MOD_EXTM',         table: 'eixos_tematicos',                               campo: 'nome',                  icon: '',                               dao: injector.get<EixoTematicoDaoService>(EixoTematicoDaoService),                                      label: "Eixo Temático",                     selectRoute: {route: ['cadastros', 'eixo-tematico']}},
            ...
            {collection: 'Integracao',                  codigo: '',                 table: 'integracoes',                                   campo: 'usuario_id',            icon: '',                               dao: injector.get<IntegracaoDaoService>(IntegracaoDaoService),                                          label: "Integração"                                  },
            ...
            {collection: 'Planejamento',                codigo: 'MOD_PLAN_INST',    table: 'planejamentos',                                 campo: 'nome',                  icon: '',                               dao: injector.get<PlanejamentoDaoService>(PlanejamentoDaoService),                                      label: "Planejamento Institucional",        selectRoute: {route: ['gestao', 'planejamento']}},
            {collection: 'PlanejamentoObjetivo',        codigo: '',                 table: 'planejamentos_objetivos',                       campo: 'nome',                  icon: '',                               dao: injector.get<PlanejamentoObjetivoDaoService>(PlanejamentoObjetivoDaoService),                      label: "Objetivo do Planejamento"                                  },
            {collection: 'Plano',                       codigo: 'MOD_PTR',          table: 'planos',                                        campo: 'numero',                icon: '',                               dao: injector.get<PlanoDaoService>(PlanoDaoService),                                                    label: "Plano de Trabalho",                 selectRoute: {route: ['gestao', 'plano-trabalho']}},
            ...
            {collection: 'PlanoEntregaEntrega',         codigo: 'MOD_PENT_ENTR',    table: 'planos_entregas_entregas',                      campo: 'descricao',             icon: '',                               dao: injector.get<PlanoEntregaEntregaDaoService>(PlanoEntregaEntregaDaoService),                        label: "Entrega do Plano de Entrega"                                  },
            ...
            {collection: 'ProgramaParticipante',        codigo: '',                 table: 'programas_participantes',                       campo: 'usuario_id',            icon: '',                               dao: injector.get<ProgramaParticipanteDaoService>(ProgramaParticipanteDaoService),                      label: "Participante do Programa"                                  },
            ...
            {collection: 'ProjetoAlocacao',             codigo: '',                 table: 'projetos_alocacoes',                            campo: 'descricao',             icon: '',                               dao: injector.get<ProjetoAlocacaoDaoService>(ProjetoAlocacaoDaoService),                                label: "Alocação"                                  },
            ...
            {collection: 'TipoAvaliacaoJustificativa',  codigo: '',                 table: 'tipos_avaliacoes_justificativas',               campo: 'tipo_avaliacao_id',     icon: '',                               dao: injector.get<TipoAvaliacaoJustificativaDaoService>(TipoAvaliacaoJustificativaDaoService),          label: "Justificativa do Tipo de Avaliação"                                  },
            ...
            {collection: 'TipoProcesso',                codigo: 'MOD_TIPO_PROC',    table: 'tipos_processos',                               campo: 'nome',                  icon: 'bi bi-foldeer-check',            dao: injector.get<TipoProcessoDaoService>(TipoProcessoDaoService),                                      label: "Tipo de Processo",                  selectRoute: {route: ['cadastros', 'tipo-processo']}},
            ...
            {collection: 'UnidadeIntegrante',           codigo: '',                 table: 'unidades_integrantes',                          campo: 'atribuicao',            icon: '',                               dao: injector.get<UnidadeIntegranteDaoService>(UnidadeIntegranteDaoService),                            label: "Integrante da Unidade"                                  },

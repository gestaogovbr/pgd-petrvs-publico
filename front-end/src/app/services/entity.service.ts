...
export class EntityService {
  ...
  public constructor(public injector: Injector) {
    ...
    this.list = [
      ...
      {
        collection: 'Afastamento',
        codigo: 'MOD_OCOR',
        table: 'afastamentos',
        campo: 'observacoes',
        icon: 'bi bi-toggle-off',
        dao: injector.get<AfastamentoDaoService>(AfastamentoDaoService),
        label: "Afastamento",
        selectRoute: {
          route: ['gestao', 'afastamento'],
        },
      },
      {
        ...
        campo: 'descricao',
        icon: 'bi bi-activity',
        dao: injector.get<AtividadeDaoService>(AtividadeDaoService),
        label: "Atividade",
        selectRoute: {
      ...
      {
        collection: 'AtividadeTarefa',
        table: 'atividades_tarefas',
        campo: 'atividade_id',
        icon: '',
        dao: injector.get<AtividadeTarefaDaoService>(AtividadeTarefaDaoService),
        label: "Tarefa da Atividade",
      },
      {
        collection: 'CadeiaValor',
        codigo: 'MOD_CADV',
        table: 'cadeias_valores',
        campo: 'nome',
        icon: 'bi bi-bar-chart-steps',
        dao: injector.get<CadeiaValorDaoService>(CadeiaValorDaoService),
      ...
      {
        collection: 'CadeiaValorProcesso',
        table: 'cadeias_valores_processos',
        campo: 'nome',
        icon: '',
        dao: injector.get<CadeiaValorProcessoDaoService>(CadeiaValorProcessoDaoService),
        label: "Processo da Cadeia de Valor",
        selectRoute: {
          route: ['gestao', 'cadeia-valor', 'processoList'],
        },
      },
      {
        collection: 'Capacidade',
        table: 'capacidades',
        campo: 'tipo_capacidade_id',
        icon: '',
        dao: injector.get<CapacidadeDaoService>(CapacidadeDaoService),
        label: "Capacidade",
      },
      {
        collection: 'CapacidadeTecnica',
        codigo: 'MOD_RX_CURR',
        table: 'capacidades_tecnicas',
        campo: 'nome',
        icon: 'bi bi-arrows-angle-contract',
        dao: injector.get<CapacidadeTecnicaDaoService>(CapacidadeTecnicaDaoService),
        label: "Capacidade Técnica",
        selectRoute: {
          route: ['raiox', 'cadastros', 'capacidade-tecnica'],
        },
      },
      {
        collection: 'Cliente',
        ...
        dao: injector.get<ClienteDaoService>(ClienteDaoService),
        label: "Clientes",
        selectRoute: {
      ...
      },
      {
        ...
        dao: injector.get<ChangeDaoService>(ChangeDaoService),
      ...
      },
      {
        ...
        campo: 'nome',
        icon: 'bi bi-building',
        dao: injector.get<CidadeDaoService>(CidadeDaoService),
        label: "Cidade",
        selectRoute: {
      ...
      {
        collection: 'ConsultaCPFSIAPE',
        icon: 'bi bi-clipboard-check',
        label: "Consulta CPF SIAPE",
      },
      {
        collection: 'ConsultaUnidadeSIAPE',
        icon: 'bi bi-clipboard2-check-fill',
        label: "Consulta Unidade SIAPE",
      },
      {
        ...
        campo: 'numero',
        icon: '',
        dao: injector.get<DocumentoDaoService>(DocumentoDaoService),
        label: "Documento",
      },
      {
        collection: 'EixoTematico',
        codigo: 'MOD_EXTM',
        table: 'eixos_tematicos',
        campo: 'nome',
        icon: 'bi bi-gear',
        dao: injector.get<EixoTematicoDaoService>(EixoTematicoDaoService),
        label: "Eixo Temático",
        selectRoute: {
      ...
      },
      {
        ...
        dao: injector.get<EntidadeDaoService>(EntidadeDaoService),
        label: "Entidade",
        selectRoute: {
      ...
      },
      {
        ...
        dao: injector.get<EntregaDaoService>(EntregaDaoService),
        label: "Entrega",
        selectRoute: {
      ...
      },
      {
        ...
        campo: 'type',
        icon: 'bi bi-bug',
        dao: injector.get<ErrorDaoService>(ErrorDaoService),
        label: "Log de Erro",
        selectRoute: {
          route: ['logs', 'error'],
        },
      },
      {
        ...
        dao: injector.get<FeriadoDaoService>(FeriadoDaoService),
        label: "Feriado",
        selectRoute: {
      ...
      },
      {
        ...
        dao: injector.get<FuncaoDaoService>(FuncaoDaoService),
        label: "Função",
        selectRoute: {
          route: ['raiox', 'cadastros', 'funcao'],
        },
      },
      {
        ...
        dao: injector.get<IntegracaoDaoService>(IntegracaoDaoService),
        label: "Integração",
      },
      {
        collection: 'Perfil',
        ...
        dao: injector.get<PerfilDaoService>(PerfilDaoService),
        label: "Perfil",
        selectRoute: {
      ...
      },
      {
        ...
        campo: 'nome',
        icon: 'bi bi-journals',
        dao: injector.get<PlanejamentoDaoService>(PlanejamentoDaoService),
      ...
      {
        collection: 'PlanejamentoObjetivo',
        table: 'planejamentos_objetivos',
        campo: 'nome',
        icon: 'bi bi-bullseye',
        dao: injector.get<PlanejamentoObjetivoDaoService>(PlanejamentoObjetivoDaoService),
        label: "Objetivo do Planejamento",
        selectRoute: {
          route: ['gestao', 'planejamento', 'objetivoList'],
        },
      },
      {
        collection: 'PlanoTrabalho',
        codigo: 'MOD_PTR',
        table: 'planos_trabalhos',
        campo: 'numero',
        icon: 'bi bi-list',
        dao: injector.get<PlanoTrabalhoDaoService>(PlanoTrabalhoDaoService),
      ...
      {
        collection: 'PlanoTrabalhoConsolidacao',
        codigo: 'MOD_PTR_CSLD',
        table: 'planos_trabalhos_consolidacoes',
        icon: 'bi bi-clipboard-check',
        dao: injector.get<PlanoTrabalhoConsolidacaoDaoService>(PlanoTrabalhoConsolidacaoDaoService),
        label: "Consolidações",
        selectRoute: {
      ...
      {
        collection: 'PlanoEntrega',
        codigo: 'MOD_PENT',
        table: 'planos_entregas',
        campo: 'nome',
        icon: 'bi bi-list-columns-reverse',
        dao: injector.get<PlanoEntregaDaoService>(PlanoEntregaDaoService),
      ...
      {
        collection: 'PlanoEntregaEntrega',
        codigo: 'MOD_PENT_ENTR',
        table: 'planos_entregas_entregas',
        campo: 'descricao',
        icon: 'bi bi-list-check',
        dao: injector.get<PlanoEntregaEntregaDaoService>(PlanoEntregaEntregaDaoService),
        label: "Entrega do Plano de Entrega",
        selectRoute: {
          route: ['gestao', 'plano-entrega', 'entrega-list'],
        },
      },
      {
        collection: 'PlanoEntregaObjetivo',
        codigo: 'MOD_PENT_OBJ',
        table: 'planos_entregas_objetivos',
        campo: 'descricao',
        icon: '',
        dao: injector.get<PlanoEntregaEntregaObjetivoDaoService>(PlanoEntregaEntregaObjetivoDaoService),
        label: "Objetivo do Plano de Entrega",
      },
      {
        collection: 'PlanoEntregaProcesso',
        codigo: 'MOD_PENT_PRO',
        table: 'planos_entregas_processos',
        campo: 'descricao',
        icon: '',
        dao: injector.get<PlanoEntregaEntregaProcessoDaoService>(PlanoEntregaEntregaProcessoDaoService),
        label: "Processo do Plano de Entrega",
      },
      {
        collection: 'Preferencia',
      ...
      },
      {
        ...
        dao: injector.get<ProgramaDaoService>(ProgramaDaoService),
      ...
      {
        collection: 'ProgramaParticipante',
        table: 'programas_participantes',
        campo: 'usuario_id',
        icon: '',
        dao: injector.get<ProgramaParticipanteDaoService>(ProgramaParticipanteDaoService),
        label: "Participante do Programa",
      },
      {
        collection: 'RelatorioArea',
        icon: 'bi bi-diagram-3-fill',
        label: "Área",
      },
      {
        collection: 'RelatorioServidor',
      ...
      },
      {
        collection: 'Solucao',
        codigo: 'MOD_SOLUCOES',
        table: 'solucao_produtos_servicos',
        campo: 'nome',
        icon: 'bi bi-cart',
        dao: injector.get<SolucaoDaoService>(SolucaoDaoService),
        label: "Soluções de Produtos e Serviços",
        selectRoute: {
          route: ['gestao', 'solucao'],
        },
      },
      {
        collection: 'TipoTarefa',
        table: 'tipos_tarefas',
        campo: 'nome',
        icon: 'bi bi-boxes',
        dao: injector.get<TipoTarefaDaoService>(TipoTarefaDaoService),
      ...
      },
      {
        ...
        campo: 'titulo',
        icon: 'bi bi-archive',
        dao: injector.get<TemplateDaoService>(TemplateDaoService),
        label: "Template",
        selectRoute: {
          route: ['cadastros', 'template'],
        },
      },
      {
      ...
      {
        collection: 'TipoAtividade',
        codigo: 'MOD_TIPO_ATV',
        table: 'tipos_atividades',
        campo: 'nome',
        icon: 'bi bi-clipboard-pulse',
        dao: injector.get<TipoAtividadeDaoService>(TipoAtividadeDaoService),
      ...
      {
        collection: 'TipoAvaliacao',
        codigo: 'MOD_TIPO_AVAL',
        table: 'tipos_avaliacoes',
        campo: 'nome',
        icon: 'bi bi-question-square',
        dao: injector.get<TipoAvaliacaoDaoService>(TipoAvaliacaoDaoService),
      ...
      {
        collection: 'TipoAvaliacaoJustificativa',
        table: 'tipos_avaliacoes_justificativas',
        campo: 'tipo_avaliacao_id',
        icon: '',
        dao: injector.get<TipoAvaliacaoJustificativaDaoService>(TipoAvaliacaoJustificativaDaoService),
        label: "Justificativa do Tipo de Avaliação",
      },
      {
        collection: 'TipoCapacidade',
        codigo: 'MOD_TIPO_CAP',
        table: 'tipos_capacidades',
        campo: 'descricao',
        icon: '',
        dao: injector.get<TipoCapacidadeDaoService>(TipoCapacidadeDaoService),
        label: "Tipo de Capacidade",
      },
      {
        collection: 'TipoCliente',
        codigo: 'MOD_TIPO_CLI',
        table: 'tipos_clientes',
        campo: 'nome',
        icon: 'bi bi-people',
        dao: injector.get<TipoClienteDaoService>(TipoClienteDaoService),
      ...
      },
      {
        ...
        campo: 'nome',
        icon: 'bi bi-files',
        dao: injector.get<TipoDocumentoDaoService>(TipoDocumentoDaoService),
      ...
      {
        collection: 'TipoJustificativa',
        codigo: 'MOD_TIPO_JUST',
        table: 'tipos_justificativas',
        campo: 'nome',
        icon: 'bi bi-window-stack',
        dao: injector.get<TipoJustificativaDaoService>(TipoJustificativaDaoService),
      ...
      {
        collection: 'TipoMotivoAfastamento',
        codigo: 'MOD_TIPO_MTV_AFT',
        table: 'tipos_motivos_afastamentos',
        campo: 'nome',
        icon: 'bi bi-list-ol',
        dao: injector.get<TipoMotivoAfastamentoDaoService>(TipoMotivoAfastamentoDaoService),
        label: this.lex.translate("Motivo de Afastamento"),
        selectRoute: {
          route: ['cadastros', 'tipo-motivo-afastamento'],
        },
      },
      {
        collection: 'TipoProcesso',
        codigo: 'MOD_TIPO_PROC',
        table: 'tipos_processos',
        campo: 'nome',
        icon: 'bi bi-folder-check',
        dao: injector.get<TipoProcessoDaoService>(TipoProcessoDaoService),
      ...
      },
      {
        ...
        dao: injector.get<TrafficDaoService>(TrafficDaoService),
        label: "Log de Tráfego",
        selectRoute: {
          route: ['logs', 'traffic'],
        },
      },
      {
        ...
        campo: 'nome',
        icon: 'fa-unity fab',
        dao: injector.get<UnidadeDaoService>(UnidadeDaoService),
        label: "Unidade",
        selectRoute: {
      ...
      {
        collection: 'UnidadeIntegrante',
        table: 'unidades_integrantes',
        campo: 'atribuicao',
        icon: '',
        dao: injector.get<UnidadeIntegranteDaoService>(UnidadeIntegranteDaoService),
        label: "Integrante da Unidade",
      },
      {
        collection: 'Usuario',
        codigo: 'MOD_USER',
        ...
        campo: 'nome',
        icon: 'bi bi-people',
        dao: injector.get<UsuarioDaoService>(UsuarioDaoService),
        label: "Usuário",
        selectRoute: {
  ...
  public getSelectRoute(collection: string): FullRoute {
    return this.list.find(x => x.collection == collection)?.selectRoute || {
      route: [],
    };
  }
}

...
export class EntityService {
    ...
    public constructor(public injector: Injector) {
        ...
        this.list = [
            ...
            { collection: 'CadeiaValorProcesso', table: 'cadeias_valores_processos', icon: '', dao: injector.get<CadeiaValorProcessoDaoService>(CadeiaValorProcessoDaoService), label: "Processo da Cadeia de Valor" },
            ...
            { collection: 'PlanejamentoObjetivo', table: 'planejamentos_objetivos', icon: 'bi bi-bullseye', dao: injector.get<PlanejamentoObjetivoDaoService>(PlanejamentoObjetivoDaoService), label: "Objetivo do Planejamento" },
            ...
            { collection: 'PlanoEntregaEntrega', codigo: 'MOD_PENT_ENTR', table: 'planos_entregas_entregas', icon: '', dao: injector.get<PlanoEntregaEntregaDaoService>(PlanoEntregaEntregaDaoService), label: "Entrega do Plano de Entrega" },

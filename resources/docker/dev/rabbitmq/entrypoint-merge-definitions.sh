#!/usr/bin/env bash
# Junta definitions.json (vhosts/filas, sem credenciais no Git) com user+permissions a partir do .env.
# Necessário no RabbitMQ 3.10+: com management.load_definitions sem "users", RABBITMQ_DEFAULT_* é ignorado.
set -euo pipefail
